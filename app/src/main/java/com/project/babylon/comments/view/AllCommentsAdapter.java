...
public class AllCommentsAdapter extends RecyclerView.Adapter<AllCommentsAdapter.ViewHolder> {
    ...
    private static final String TAG = AllCommentsAdapter.class.getName();
    ...
    public AllCommentsAdapter(List<CommentModel> musicModelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_all_comment, parent, false);
